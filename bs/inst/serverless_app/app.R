...
source("../../R/check_ast.R")
source("../../R/utils.R")
source("../../R/plottingInternally.R")
source("../../R/lc50.r")
source("../../R/correlation.R")
source("../../R/visualisation.R")
source("../../R/assumption.R")
source("../../R/statisticalTests.R")
source("../../R/DoseResponse.R")

# NOTE: this is the content of ../R/app.R
ui <- fluidPage(
  useShinyjs(),
  includeScript("inst/www/download.js"),
  sidebarLayout(
    sidebarPanel(
      conditionalPanel(
...
server <- function(input, output, session) {
  ...
  download_file <- reactive({
    file <- download(session, "/home/shiny/results")
