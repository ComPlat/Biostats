get_ast <- function(inp) {
  ...
  allowed_fcts <- c(
   ...
   "grep", "substr", "sub", "paste", "paste0", "strsplit", "tolower", "toupper",
   "dnorm", "pnorm", "qnorm", "rnorm", "dbinom", "pbinom", "qbinom", "rbinom", "dpois",
   "ppois", "rpois", "dunif", "punif", "qunif", "runif",
   "mean", "sd", "median", "quantile", "range", "sum", "diff", "min", "max", "scale",
